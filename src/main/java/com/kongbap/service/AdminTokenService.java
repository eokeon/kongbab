...
public class AdminTokenService {
    ...
    public static final String TOKEN_COOKIE_NAME = "KONGBAP_ADMIN_TOKEN";
    ...
    @Value("${kongbap.admin.password:kongbap1234}")
    private String adminPassword;

    @Value("${kongbap.security.token-secret:}")
    private String customTokenSecret;

    @Value("${kongbap.security.cookie.secure:false}")
    private boolean forceCookieSecure;

    private static final String HMAC_ALGORITHM = "HmacSHA256";
    private static final String DEFAULT_SALT = "KONGBAP_SECRET_SALT_2026_SECURE";
