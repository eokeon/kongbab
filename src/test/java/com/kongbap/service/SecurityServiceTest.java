...
class SecurityServiceTest {
    ...
    void testBotDetectionFilter() throws Exception {
        com.kongbap.config.BotDetectionFilter filter = new com.kongbap.config.BotDetectionFilter(adminTokenService);
    ...
    void testRateLimitingFilter() throws Exception {
        com.kongbap.config.RateLimitingFilter filter = new com.kongbap.config.RateLimitingFilter(adminTokenService);
        ReflectionTestUtils.setField(filter, "enabled", true);
